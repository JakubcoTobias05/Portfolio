...
class Db
{
	 ...
	 */
	public static function connect(string $host, string $database, string $user, string $password)
	{
	 ...
	 */
	private static function executeStatement(array $params)
	{
	 ...
	 */
	public static function querySingle(string $query)
	{
		$statement = self::executeStatement(func_get_args());
	 ...
	 */
	public static function queryOne(string $query)
	{
		$statement = self::executeStatement(func_get_args());
	 ...
	 */
	public static function queryAll(string $query)
	{
		$statement = self::executeStatement(func_get_args());
	 ...
	 * @throws Exception Chyba
	 */
	public static function update(string $table, array $data, string $condition)
	{
		$keys = array_keys($data);
		self::checkIdentifiers(array($table) + $keys);
		$query = "
	 ...
	 * @throws \Exception
	 */
	private static function checkIdentifiers(array $identifiers)
	{
